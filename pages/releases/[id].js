  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <Image src={release.artwork} width="300" height="300" alt="artwork" />
        <div className={styles.details}>
          ...
          {release.description && (
            <div className={styles.description}>
              ...
              {isDasGiddy && (
                <a
                  href="https://www.youtube.com/watch?v=4iFjB4qpZlE"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="colouredLink"
                >
                  intro track.
                </a>
              )}
      ...
      <div className={styles.releaseHomeButtonContainer}>
        {id - 1 > 0 && (
          <div className={styles.releaseHomeButton}>
            <Button link={`/releases/${parseInt(id, 10) - 1}`}>Previous</Button>
          </div>
        )}
        <div className={styles.releaseHomeButton}>
          <Button link="/releases">Back</Button>
        ...
        <div className={styles.releaseHomeButton}>
          <Button link={`/releases/${parseInt(id, 10) + 1}`}>Next</Button>
        </div>
      </div>
    </div>
  );
