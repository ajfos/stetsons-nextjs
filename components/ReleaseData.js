 ...
 export const releases = [
    ...
    },
    {
        ...
        description: "Tommy 2 found a hat in a taxi. It was glittery and a stetson. Rumour has it that wearing this on a night out causes fights, although this is unconfirmed."
    }, 
    {
        name: 'Dirty Ripper',
        year: 2018,
    ...
    },
    {
        ...
        soundcloud: null,
        bandcamp: null,
        description: "この曲は日本についてないけど、「Tommy -1」は他の人を考えているかもしれませんでした。　「Tommy -1」は家族と日本に行ったことがありますが、「The Prospector」は「Tommy 2」と一緒に日本に行きました。　とても楽しかったです。"
    },
    {
        name: 'Last Chance',
        year: 2018,
